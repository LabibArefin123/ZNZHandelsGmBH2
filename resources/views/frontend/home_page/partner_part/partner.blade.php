    ...
    <div class="container">
        ...
        <div class="grid-container">
            <div class="grid-class">
                <div class="grid-item">
                    <a href="https://event.amfori.org/" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset('images/amfori.png') }}" alt="amfori">
                    </a>
                </div>
                <div class="grid-item">
                    <a href="https://labib.work/" target="_blank" rel="noopener noreferrer">
                        <img src="{{ asset('images/partner_part/Google.png') }}" alt="Partner">
                    </a>
                </div>
                ...
                <div class="grid-item">
                    <a href="https://www.textilestandards.com/standards/43-bsci" target="_blank"
                        ...
                        <img src="{{ asset('images/bsci.png') }}" alt="BSCI">
                    </a>
                </div>
            </div>
        </div>
